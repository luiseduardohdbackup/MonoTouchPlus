...
//https://raw.github.com/detroitpro/MBProgressHUD-MonoTouch/master/MbProgressHud.cs
using System;
...
namespace MonoTouchPlus
{
	...
	public class MBProgressHUD : UIView
	{
		...
		{
			//handle exception:Object reference not set to a instance of an object
			if (null != this.Indicator &&  null != this.Bounds) {
